<template>
  <form>
    ...
    <span class="spans">价格 :</span>
    <input v-model="newPizza.price2" type="text" class="form-control col-4" id="Input2">
    <button
      type="button"
...
export default {
  ...
  methods: {
    addPizza() {
      ...
      axios.post("/menu-lsx.json", data).then(res => {
